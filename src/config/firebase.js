...
const firebaseConfig = {
  apiKey: 'AIzaSyDYEcoMvbPuodl6IuyZ7jGBes92eSJZDno',
  authDomain: 'test-app-42d7e.firebaseapp.com',
  projectId: 'test-app-42d7e',
  storageBucket: 'test-app-42d7e.appspot.com',
  messagingSenderId: '136088374578',
  appId: '1:136088374578:web:37d520aed687ef49f19b2b',
  measurementId: 'G-NHRVE7FE7K',
};
